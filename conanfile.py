...
class ConanConfig(QtConanFile):
    ...
    git_url = "git@git.100tal.com:epg_xhb_solution/talcloud_khaos_multimedia.git"
    git_branch = "develop/master"

    description = "MultiMedia Library"

    requires = "QtComposition/master@cmguo/stable", "QtEventBus/master@cmguo/stable", "QtAv/1.0@tal/stable", "qtpromise/v0.5.0@cmguo/stable", "ShowBoard/develop@cmguo/test"
